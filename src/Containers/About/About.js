                ...
                <div className='whoAmIContainer'>
                    <div className='whoAmIPadding'>
                        ...
                        <div className="aboutMeText aboutCloser1">
                            In my free time I am an avid runner and November Project tribe member, and enjoy <Link style={{ textDecoration: 'none', color: 'rgb(35,64,143)' }} to="/photography">photography</Link>, action sports and exploring Atlanta’s many neighborhoods and restaurants with my wife. I am also a volunteer with the Leukemia & Lymphoma Society.
                        </div>
                    </div>
                </div>
