                ...
                <div className='whoAmIContainer'>
                    <div className='whoAmIPadding'>
                        ...
                        <div className="aboutMeText aboutCloser1">
                            In my free time I am an avid runner and <a style={{ textDecoration: 'none', color: 'rgb(35,64,143)' }} href='https://november-project.com/' rel="noopener noreferrer" target="_blank">November Project</a> tribe member, and enjoy <Link style={{ textDecoration: 'none', color: 'rgb(35,64,143)' }} to="/media">writing and photography</Link>, reading and exploring Atlanta’s many neighborhoods and restaurants with my wife. I am also a graphic design and photography volunteer with the <a style={{ textDecoration: 'none', color: 'rgb(35,64,143)' }} href='https://www.lls.org/' rel="noopener noreferrer" target="_blank">Leukemia & Lymphoma Society</a>.
                        </div>
                    </div>
                </div>
