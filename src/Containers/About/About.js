            ...
            <div className="bioGrid">
                ...
                <div className='whoAmIPadding'>
                    ...
                    <div className="aboutMeText">
                        ...
                        <div>In my free time I am an avid long distance runner, and enjoy <Link style={{ textDecoration: 'none', color: 'rgb(35,64,143)' }} to="/photography">photography</Link>, live music, and exploring Atlanta with my wife.</div>
                    </div>     
                </div>
            </div>
