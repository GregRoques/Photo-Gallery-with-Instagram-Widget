...
const musicPhotos = {
  ...
  3: {
    ...
    website:
      "https://www.whereyat.com/broken-social-scene-brings-hugs-and-thunder-to",
    target: "_blank",
  },
  4: {
  ...
  5: {
    ...
    website:
      "https://www.whereyat.com/drake-and-the-three-migos-conquer-the-smoothie-king-center",
    target: "_blank",
  },
  6: {
    band: `Lil' Wayne`,
    ...
    website:
      "https://www.whereyat.com/lil-weezyana-fest-celebrates-top-selling",
    target: "_blank",
  },
  7: {
    ...
    website:
      "https://www.whereyat.com/after-laughter-tour-brings-smiles-to-champion",
    target: "_blank",
  },
  8: {
    band: "Fall Out Boy",
  ...
  return (
    <div>
      ...
      <div className="photoContent">
        <div
          onClick={() => clickL()}
          className="picButtons buttonLeft"
        >{`<`}</div>
        <div
          className="sliderContainer"
          onContextMenu={preventDefaultHander}
          onDragStart={preventDefaultHander}
        >
          <img
            src={musicPhotos[currentNum]["image"]}
            alt={musicPhotos["band"]}
          />
        </div>
        <div
          onClick={() => clickR()}
          className="picButtons buttonRight"
        >{`>`}</div>
      </div>
      <div className="picTextAlign">
        <a
          rel="noopener noreferrer"
          target={musicPhotos[currentNum]["target"]}
          href={musicPhotos[currentNum]["website"]}
          alt={musicPhotos[currentNum]["band"]}
        >
